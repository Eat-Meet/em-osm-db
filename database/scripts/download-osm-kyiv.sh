...
echo "Download OSM data for Kyiv region."
...
osm2pgsql -c -U $DB_USERNAME -l -d $DB_NAME -H $DB_ADDRESS --hstore --output-pgsql-schema=$SCHEMA_NAME lviv_oblast-latest.osm.pbf || { echo "OSM Migration failed"; exit 1; }
